...
/// <summary>
/// <c>dndump eestack</c> -- CLI_DESIGN.md §4.3. Show grouped stack traces (SOS name, default 30 frames).
/// </summary>
public static class EEStackCommand {
	...
	public static Command Create() {
		var command = new Command("eestack", "Grouped stack traces from all threads (SOS name, default 30 frames).");
