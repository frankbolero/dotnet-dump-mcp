...
internal static class ExitCodeMapper {
	public static int Map(Exception ex) => ex switch {
		...
		// Core-side dump resolution failure (no dump provided)
		DumpResolutionException => ExitCodes.UsageError,
		...
		// Core-side dump load failure
		Core.Utilities.DumpLoadException => ExitCodes.DumpLoadFailure,
